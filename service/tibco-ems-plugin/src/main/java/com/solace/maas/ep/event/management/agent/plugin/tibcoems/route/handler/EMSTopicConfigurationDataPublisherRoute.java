...
import com.solace.maas.ep.event.management.agent.plugin.tibcoems.processor.EMSTopicConfigurationListingProcessor;
...
public class EMSTopicConfigurationDataPublisherRoute extends DataPublisherRouteBuilder {
    ...
    @Autowired
    public EMSTopicConfigurationDataPublisherRoute(EMSTopicConfigurationListingProcessor processor, RouteManager routeManager,
